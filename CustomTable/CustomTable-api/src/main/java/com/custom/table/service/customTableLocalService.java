...
/**
 * Provides the local service interface for customTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see customTableLocalServiceUtil
...
public interface customTableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link customTableLocalServiceUtil} to access the custom table local service. Add custom service methods to {@link com.custom.table.service.impl.customTableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public customTable createcustomTable(long customTableId);
	...
	*/
	...
	public customTable deletecustomTable(customTable customTable);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public customTable deletecustomTable(long customTableId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public customTable fetchcustomTable(long customTableId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public customTable getcustomTable(long customTableId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<customTable> getcustomTables(int start, int end);
